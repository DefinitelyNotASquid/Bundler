...
public class BundlerConsoleView implements ProjectComponent {

  private final Project project;
  private ConsoleView consoleView;

  public BundlerConsoleView(Project project) {
   ...
   *
   * <p>Check {@link BundlerSeverity} for the available message severity types
   *
   * @param message the message to be printed to the console
   * @param severity the severity of the printed message
   */
  public void print(@Nullable String message, BundlerSeverity severity) {
